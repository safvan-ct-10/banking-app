    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}" autocomplete="off" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter name" autocomplete="off" name="name" value="{{ old('name') }}" required autofocus autocomplete="off"/>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Email address</label>
                            <input type="email" class="form-control" placeholder="Enter email" autocomplete="off" name="email" value="{{ old('email') }}" required autofocus autocomplete="off"/>
                        </div>
                        <div class="mb-2">
            ...
            <div class="text-center text-muted mt-3">
                ...
                <a href="{{ route('/') }}" tabindex="-1">Sign in</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
